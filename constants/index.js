export const exploreWorlds = [
  ...
  {
    id: 'option-4',
    imgUrl: '/sandwichplatter.jpeg',
    title: 'Sandwich Platter',
    content: ['Assorted bagels', 'Lox', 'Avocado smash', 'Soft boiled eggs', 'Chili crisp', 'Raw&pickled things'],
  },
  {
    id: 'option-5',
    imgUrl: '/partyfavors.jpeg',
    title: 'Party Favors',
    content: ['Assorted bagels', 'Lox', 'Avocado smash', 'Soft boiled eggs', 'Chili crisp', 'Raw&pickled things'],
  },
];
...
export const bagels = ['/bagel-named.svg', '/blacklime.svg', '/pecan.svg', '/pumpernickle.svg', '/seaweed.svg', '/urfa.svg', '/poppy.svg'];
...
export const projects3 = [
  ...
  {
    name: '[Unknown] - A cool future project as an intern at Bluecadet this coming fall',
    role: ['TBD', "Don't know yet", 'Unknown'],
    photo: '/bluecadet-cover.png',
    description: '',
    link: 'https://www.bluecadet.com/',
    linkHeader: 'Check out Bluecadet;)',
  },
];
